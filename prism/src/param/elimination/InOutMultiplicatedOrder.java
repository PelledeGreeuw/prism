...
public class InOutMultiplicatedOrder extends EliminationOrderIterator {
	private BitSet eliminatedStates;

	public InOutMultiplicatedOrder(MutablePMC pmc, int initialState, PrismComponent parent) {
	...
	@Override
	public Integer next() {
		Map<Integer, Integer> results = IntStream.range(0, pmc.getNumStates()).boxed()
